...
class PDFDocument extends PDFDocumentSource {
    ...
    resetPeerTable() {
        ...
        this.headerHeight = 0;
        this.headerHeightAndFirstLine = 0;
    ...
    createTitles() {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const calc = yield this.calcTitleSubtitleHeaderAndFirstLine();
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    this.headerHeightAndFirstLineAndTitleCalc = (yield this.calcTitleSubtitleHeaderAndFirstLine()) + this.positionY;
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    if (this.headerHeightAndFirstLine === 0) {
                        if (datas.length > 0) {
                            this.headerHeightAndFirstLine = Number(yield this.calcRowHeightObject(datas[0], { isHeader: true }));
                            this.logg(this.headerHeightAndFirstLine, 'datas');
                        }
                        else if (rows.length > 0) {
                            this.headerHeightAndFirstLine = Number(yield this.calcRowHeightString(rows[0], { isHeader: true }));
